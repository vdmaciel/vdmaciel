...
#### 2. One-Way Send (Fire-and-Forget)
...
#### 3. Deferred Response (Split Request-Response)
...
In the following subposts, we will explore some common communication patterns and how they can be implemented using the primitives we have defined.

Each pattern serves different use cases and has its own advantages and trade-offs, which we will discuss in detail.
