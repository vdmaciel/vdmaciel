...
description: 'Exploring the inner workings of the backtracking algorithm and its variations.'
date: 2026-02-22
tags: [DSA]
authors: ['vdmaciel']
...
- [Permutation Problems](./dsa_backtracking/permutation_problems)
- [Combination Problems](./dsa_backtracking/combination_problems)
- [Subset Problems](./dsa_backtracking/subset_problems)